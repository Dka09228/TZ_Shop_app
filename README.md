...
Проект реализован как техническое задание с использованием backend на FastAPI, frontend на Next.js и PostgreSQL в качестве базы данных. Все сервисы поднимаются через Docker Compose.
